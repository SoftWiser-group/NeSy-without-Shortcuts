...
parser.add_argument('--trun', type=bool, default=False, help='Using variational inference framework')
parser.add_argument('--z_sigma', type=float, default=1, help='Using variational inference framework')
parser.add_argument('--target_sigma', type=float, default=1e-1, help='Using variational inference framework')
...
print('| Initial Learning Rate = ' + str(adam_lr))
